/*tic_toc_toe game . this game can be play played by 2 users 
 * the first player can click on any button the value of the button will be 'x'
 * when the second player clicks the button the value  of the button will be o.
 */
